...
- [Firefox Multi-Account Containers (MAC)](https://addons.mozilla.org/en-US/firefox/addon/multi-account-containers): Use if you want to keep different set of cookies such as login info for a site. If you have no such need, not using it will have no direct impact on your privacy when using Total Cookie Protection (TCP) / dynamic First Party Isolation (dFPI).

Disabling Total Cookie Protection (TCP) / dynamic First Party Isolation (dFPI) will expose you to cross-site cookies, which weaken your privacy a lot. Therefore:

<ul>
<li>Do not use cookie-related extensions that don't work well with Total Cookie Protection (TCP) / dynamic First Party Isolation (dFPI) and/or Multi-Account Containers, such as Cookie AutoDelete.</li>
<li>Due to <a href="https://bugzilla.mozilla.org/show_bug.cgi?id=1767271">Bug 1767271</a>, adding a site to cookie-clearing exception will also disable it from Total Cookie Protection (TCP) / dynamic First Party Isolation (dFPI). Thus, do not add any cookie-clearing exception for untrusted sites. If you want some cookies to be preserved just disable cookie clearing. This will have no direct impact on your privacy when using Total Cookie Protection (TCP) / dynamic First Party Isolation (dFPI) except for the scenario that you also change your IP address, at which you should consider clearing cookies for anonymity.</li>
<li>You can view, delete, edit, import, and export cookies using an extension that is compatible with Total Cookie Protection (TCP) / dynamic First Party Isolation (dFPI) and Multi-Account Containers. I recommend Cookie Manager. Refer to [Cookie Manager](#cookie_manager) for more information.</li>
</ul>
...
For people with higher threat model, consider enabling [resistfingeprinting (RFP)](https://support.mozilla.org/en-US/kb/resist-fingerprinting). RFP is a built-in solution in Firefox that blocks or randomizes many metrics without requiring a crowd like Tor Browser. However, expect a lot of site-breakings when using it, which is mostly due to canvas randomizing. Do not use CanvasBlocker and My Fingerprint when using resistfingerprinting (RFP).
...
<tr id="canvasblocker"><td>CanvasBlocker</td><td><a href="https://github.com/kkapsner/CanvasBlocker">GitHub</a></td><td><a href="https://addons.mozilla.org/en-US/android/addon/canvasblocker">Android</a></td><td><a href="https://addons.mozilla.org/en-US/firefox/addon/canvasblocker">Desktop</a></td><td>2</td><td><a href="CanvasBlocker-settings.json">CanvasBlocker-settings.json</a> is my settings. To apply it, go to <a href="https://github.com/Willie169/browser-privacy-guide/raw/refs/heads/main/CanvasBlocker-settings.json">https://github.com/Willie169/browser-privacy-guide/raw/refs/heads/main/CanvasBlocker-settings.json</a> to download the file, go to options page by clicking the hyperlink in the welcome page or clicking Preferences of the extension, click Load in CanvasBlocker settings export, and select the file. Do not use CanvasBlocker when using resistfingerprinting (RFP). Refer to <a href="#firefox-fingerprint">Firefox Fingerprint</a> section for more information.</td><td>Alters some JS APIs to prevent fingerprinting.</td></tr>
...
<tr id="cookie_manager"><td>Cookie Manager</td><td><a href="https://github.com/Rob--W/cookie-manager">GitHub</a></td><td><a href="https://addons.mozilla.org/en-US/android/addon/a-cookie-manager">Android</a></td><td><a href="https://addons.mozilla.org/en-US/firefox/addon/a-cookie-manager">Desktop</a></td><td>1</td><td><blockquote>
...
<tr><td>LibRedirect</td><td><a href="https://github.com/libredirect/browser_extension">GitHub</a></td><td><a href="https://addons.mozilla.org/en-US/android/addon/libredirect">Android</a></td><td><a href="https://addons.mozilla.org/en-US/firefox/addon/libredirect">Desktop</a></td><td>1</td><td>Use if you want to redirect social media to alternative frontends.</td><td>Redirects YouTube, Twitter, TikTok... requests to alternative privacy friendly frontends.</td></tr>
...
<tr id="my_fingerprint"><td>My Fingerprint</td><td><a href="https://github.com/omegaee/my-fingerprint">GitHub</a></td><td><a href="https://addons.mozilla.org/en-US/android/addon/my-fingerprint">Android</a></td><td><a href="https://addons.mozilla.org/en-US/firefox/addon/my-fingerprint">Desktop</a></td><td>2</td><td><a href="My_Fingerprint.json">My_Fingerprint.json</a> is my settings. To apply it, go to any site, click My Fingerprint from Extensions, go to <code>Config > Script Config</code> and turn on Fast Injection Mode, go to <code>More > Subscribe</code>, paste <code>https://raw.githubusercontent.com/Willie169/browser-privacy-guide/refs/heads/main/My_Fingerprint.json</code> in it, and click the check mark. Do not use My Fingerprint when using resistfingerprinting (RFP). Refer to <a href="#firefox-fingerprint">Firefox Fingerprint</a> section for more information.</td><td>Protect Your Browser Fingerprints</td></tr>
<tr><td>NoScript Security Suite</td><td><a href="https://github.com/hackademix/noscript">GitHub</a></td><td><a href="https://addons.mozilla.org/en-US/android/addon/noscript">Android</a></td><td><a href="https://addons.mozilla.org/en-US/firefox/addon/noscript">Desktop</a></td><td>1/2</td><td>Despite that its functionality is largely covered by uBlock Origin and preferences, when your intended behavior is simply block unless manually allowed, NoScript Security Suite may be easier to use. If that's not what you want, you probably should not use this extension and should use uBlock Origin instead.</td><td>The best security you can get in a web browser! Allow potentially malicious web content to run only from sites you trust. Protect yourself against XSS other web security exploits.</td>
...
<tr><td>User-Agent Switcher</td><td><a href="https://gitlab.com/ntninja/user-agent-switcher">GitLab</a></td><td><a href="https://addons.mozilla.org/en-US/android/addon/uaswitcher">Android</a></td><td>Not recommended on desktop, use User-Agent Switcher and Manager instead.</td><td>1</td><td>Only change user agent string when you explicitly want to. Changing it by default may lead to inconsistent metrics and cause you to be more trackable. It is recommended to spoof it to Chrome on YouTube to prevent YouTube's intentional slowing loads.</td><td>Easily override the browser's User-Agent string</td></tr>
<tr><td>User-Agent Switcher and Manager</td><td><a href="https://github.com/ray-lothian/UserAgent-Switcher">GitHub</a></td><td>Not available on Android, use User-Agent Switcher instead.</td><td><a href="https://addons.mozilla.org/en-US/firefox/addon/user-agent-string-switcher">Desktop</a></td><td>1</td><td>Only change user agent string when you explicitly want to. Changing it by default may lead to inconsistent metrics and cause you to be more trackable. It is recommended to spoof it to Chrome on YouTube to prevent YouTube's intentional slowing loads.</td><td>Spoof websites trying to gather information about your web navigation—like your browser type and operating system—to deliver distinct content you may not want.</td></tr>
...
- Extensions that allow background audio/video playback on sites such as YouTube: Achieved in uBlock Origin with <a href="https://gitlab.com/celenityy/BadBlock/-/raw/pages/hardened/block-page-visibility.txt">Block Page Visibility</a> list.
