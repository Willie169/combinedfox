...
The settigns apply for all Firefox (desktop), Fennec F-Droid, and Firefox for Android. Note that my settings for CanvasBlocker, Chameleon, and My Fingerprint are designed to be used together. One of the main reason is to solve <https://github.com/kkapsner/CanvasBlocker/issues/473>. Disable one of them may cause fingerprint leak.
