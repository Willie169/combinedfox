...
- [Firefox Multi-Account Containers (MAC)](https://addons.mozilla.org/en-US/firefox/addon/multi-account-containers): Use if you want to keep different set of cookies such as login info for a site. If you have no such need, this won't enhance your privacy more than Enhanced Tracking Protection (ETP) Strict Mode.
