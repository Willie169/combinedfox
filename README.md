...
<tr><td>NoScript Security Suite</td><td><a href="https://github.com/hackademix/noscript">GitHub</a></td><td><a href="https://addons.mozilla.org/en-US/android/addon/noscript">Android</a></td><td><a href="https://addons.mozilla.org/en-US/firefox/addon/noscript">Desktop</a></td><td>1/2</td><td>For people with higher threat model. While its functionality is covered by uBlock Origin, when your intended behavior is simply blocking unless manually allowed, this can be easier to use. If that's not what you want, do not use this extension and use uBlock Origin instead.</td><td>The best security you can get in a web browser! Allow potentially malicious web content to run only from sites you trust. Protect yourself against XSS other web security exploits.</td>
