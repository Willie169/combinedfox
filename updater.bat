...
TITLE combinedfox user.js updater

REM ## combinedfox user.js updater for Windows
REM ## author: @claustromaniac @Willie169
REM ## version: 4.21
REM ## instructions: https://github.com/Willie169/combinedfox/wiki/2-Usage
...
IF DEFINED _updateb (
	...
	IF NOT "!_myname:~0,9!"=="[updated]" (
		...
		CALL :psdownload https://raw.githubusercontent.com/Willie169/combinedfox/main/updater.bat "[updated]!_myname!.bat"
		IF EXIST "[updated]!_myname!.bat" (
...
ECHO:
ECHO:                #################################################
ECHO:                #### combinedfox user.js Updater for Windows ####
ECHO:                ####     by claustromaniac and Willie169     ####
ECHO:                ####                  v!v!                  ####
ECHO:                #################################################
ECHO:
SET /A "_line=0"
...
IF NOT DEFINED _ua (
	...
	ECHO:  It will download the latest version of combinedfox user.js from github and then
...
CALL :psdownload https://raw.githubusercontent.com/Willie169/combinedfox/main/user.js "user.js.new"
