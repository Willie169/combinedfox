...
## browser-privacy-guide Betterfox user.js downloader for macOS and Linux
...
usage() {
  echo
  echo -e "${BLUE}Usage: $0 [-bcdehlnrsuv] [-p PROFILE] [-o OVERRIDE_DIR]${NC}" 1>&2  # Echo usage string to standard error
  echo -e "
Optional Arguments:
    ...
    -o OVERRIDE_DIR  Path to overrides file for Arkenfox, that is,
                     path that this script download Betterfox Peskyfox.js to.
...
wget https://raw.githubusercontent.com/yokoffing/Betterfox/refs/heads/main/Peskyfox.js
wget https://raw.githubusercontent.com/yokoffing/Betterfox/refs/heads/main/Fastfox.js
